...
#include "armos_interfaces/msg/detail/armos_joint_control__rosidl_typesupport_fastrtps_c.h"
...
using _ArmosJointControl__ros_msg_type = armos_interfaces__msg__ArmosJointControl;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ArmosJointControl__ros_msg_type * ros_message = static_cast<const _ArmosJointControl__ros_msg_type *>(untyped_ros_message);
  // Field name: mode
  {
  ...
  void * untyped_ros_message)
{
  ...
  _ArmosJointControl__ros_msg_type * ros_message = static_cast<_ArmosJointControl__ros_msg_type *>(untyped_ros_message);
  // Field name: mode
  {
    cdr >> ros_message->mode;
  }
...
size_t get_serialized_size_armos_interfaces__msg__ArmosJointControl(
  const void * untyped_ros_message,
...
static uint32_t _ArmosJointControl__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_armos_interfaces__msg__ArmosJointControl(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_armos_interfaces
size_t max_serialized_size_armos_interfaces__msg__ArmosJointControl(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = armos_interfaces__msg__ArmosJointControl;
    is_plain =
      (
...
static size_t _ArmosJointControl__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_armos_interfaces__msg__ArmosJointControl(
...
static message_type_support_callbacks_t __callbacks_ArmosJointControl = {
...
static rosidl_message_type_support_t _ArmosJointControl__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ArmosJointControl,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, armos_interfaces, msg, ArmosJointControl)() {
  return &_ArmosJointControl__type_support;
}
