...
bool armos_interfaces__msg__armos_joint_control__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("armos_interfaces.msg._armos_joint_control.ArmosJointControl", full_classname_dest, 59) == 0);
  }
  armos_interfaces__msg__ArmosJointControl * ros_message = _ros_message;
  {  // mode
...
{
  /* NOTE(esteve): Call constructor of ArmosJointControl */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("armos_interfaces.msg._armos_joint_control");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ArmosJointControl");
