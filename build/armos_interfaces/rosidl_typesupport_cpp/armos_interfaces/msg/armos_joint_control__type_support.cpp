...
static const _ArmosJointControl_type_support_symbol_names_t _ArmosJointControl_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, armos_interfaces, msg, ArmosJointControl)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, armos_interfaces, msg, ArmosJointControl)),
  }
};
...
{
  return &::armos_interfaces::msg::rosidl_typesupport_cpp::ArmosJointControl_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, armos_interfaces, msg, ArmosJointControl)() {
  return get_message_type_support_handle<armos_interfaces::msg::ArmosJointControl>();
}
